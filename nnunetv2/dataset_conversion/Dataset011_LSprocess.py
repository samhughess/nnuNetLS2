...
def convert_msd_dataset(source_folder: str, overwrite_target_id: Optional[int] = None,
    ...
    #target_dataset_name = f"Dataset0{target_id}_{dataset_name}/target"
    target_dataset_name = "Dataset012_target"
    ...
    #got rid of these since seemed to be conversions from earlier version
...
if __name__ == '__main__':
    convert_msd_dataset('/Users/samanthahughes/nnUNet/nnunetv2/nnuNet_raw/Dataset011_LS')